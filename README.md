...
**Embed it** — the `currentColor` wordmark adapts to your surrounding text colour
(dark on light, light on dark):

```html
<a href="https://ack3.ai" rel="noopener">
  <img src="ack3-wordmark.svg" alt="Audited by ack3" height="24">
</a>
```

**Naming:** always lowercase, one word, ending in the numeral `3` — `ack3`.
Never *Ack3*, *ACK3*, *ackee3*, or *ack 3*.
...
| Colour | Hex | Role |
|---|---|---|
| Near-black | `#0E0F12` | Surface / the mark on light |
| Off-white | `#EDEDEF` | Text / the mark on dark |
| Surface | `#17181C` | Raised panels |
| Cyan | `#00FFFF` | Accent |
| Blue | `#0000FF` | Primary action |
| Fuchsia | `#FF00FF` | Accent |
...
- **Minimum size** — wordmark at least **24px** tall; smaller than that, use the icon.
...
- Re-typeset the name in another font, or drop the cursor block.
